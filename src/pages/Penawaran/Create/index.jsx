...
import { Card, CardBody, Col, Container, Row, Input, Form, Table, FormFeedback, Label } from "reactstrap";
                      ...
                      <Col lg={6}>
                        <div className="mb-3">
                          ...
                          <Input
                            ...
                            readOnly
                            value={detailPo.mol.spesial_intruksi}
                          />
                        </div>
                      </Col>
                      <Col lg={6}>
