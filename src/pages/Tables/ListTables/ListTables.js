                        ...
                        <ListGroupItem data-id="1">
                          <div className="d-flex">
                            <div className="flex-grow-1">
                              ...
                              <p className="born timestamp text-muted mb-0" data-timestamp="12345">
                                1986
                              </p>
                            </div>
                        ...
                        <ListGroupItem data-id="2">
                          <div className="d-flex">
                            <div className="flex-grow-1">
                              ...
                              <p className="born timestamp text-muted mb-0" data-timestamp="23456">
                                1985
                              </p>
                            </div>
                            <div className="flex-shrink-0">
                        ...
                        <ListGroupItem data-id="3">
                          <div className="d-flex">
                            <div className="flex-grow-1">
                              ...
                              <p className="born timestamp text-muted mb-0" data-timestamp="34567">
                                1986
                              </p>
                            </div>
                            <div className="flex-shrink-0">
                        ...
                        <ListGroupItem data-id="4">
                          <div className="d-flex">
                            <div className="flex-grow-1">
                              ...
                              <p className="born timestamp text-muted mb-0" data-timestamp="45678">
                                1983
                              </p>
                            </div>
                            <div className="flex-shrink-0">
        ...
        <form className="tablelist-form">
          ...
          <ModalFooter>
            <div className="hstack gap-2 justify-content-end">
              <button type="button" className="btn btn-light" onClick={() => setmodal_list(false)}>
                Close
              </button>
      ...
      >
        ...
        <ModalBody>
          ...
          <div className="d-flex gap-2 justify-content-center mt-4 mb-2">
            ...
            <button type="button" className="btn w-sm btn-danger " id="delete-record">
              Yes, Delete It!
            </button>
          </div>
        </ModalBody>
