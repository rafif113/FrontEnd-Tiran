...
import { postFakeForgetPwd, postJwtForgetPwd } from "../../../helpers/backend_helper";
...
export const userForgetPassword = (user, history) => async (dispatch) => {
  try {
    ...
    if (data) {
      dispatch(userForgetPasswordSuccess("Reset link are sended to your mailbox, check there first"));
    }
  } catch (forgetError) {
